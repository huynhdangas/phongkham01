      ...
      <div class="container">
        ...
        <form action="#">
          <div class="input-group input-navbar">
            ...
            <input type="text" class="form-control" placeholder="Nhập từ khoá..." aria-label="Username" aria-describedby="icon-addon1">
          </div>
        </form>
    ...
    <div class="container py-5 py-lg-0">
      <div class="row align-items-center">
        ...
        <div class="col-lg-8 wow fadeInRight">
          <h1 class="font-weight-normal mb-3" style="font-size:2.5rem; font-weight:500">Get easy access of all features using One Health Application</h1>
